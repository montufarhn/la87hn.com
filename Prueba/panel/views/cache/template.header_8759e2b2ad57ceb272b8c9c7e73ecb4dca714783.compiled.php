...
<html lang="en">
 ...
 <title><?php echo \htmlentities(( ( empty( $settings[ 'title' ] ) ) ? 'PawTunes Radio Player' : $settings[ 'title' ] )??'', ENT_QUOTES, 'UTF-8', false); ?> :: Control Panel</title>
 ...
 */
 ...
 var version = "<?php echo \htmlentities($version??'', ENT_QUOTES, 'UTF-8', false); ?>";
 </script>
 </head>
 <body>
 <?php if( $panel->isAuthorized() ): ?>
 <section class="intro small">
 <div class="container content">
 <div class="heading">
 <div class="logo">
 <img width="auto" height="70" src="./assets/logo.svg" alt="PawTunes Logo">
 <div class="version">Release <span class="release"><?php echo \htmlentities($version??'', ENT_QUOTES, 'UTF-8', false); ?></span></div>
 </div>
 <h1>PawTunes</h1>
 </div>
